...
This study aims to predict the presence of metastasis and the presence of CNS metastasis in free-text, unstructured radiology reports of NSCLC patients. 
1) We selected the GatorTron model developed by researchers at the University of Florida to fine-tune for our prediction tasks. We accessed the GatorTron-Base model through HuggingFace
...
5) The annotated notes were used to conduct a 5-fold cross-validation to tune the GatorTron model. A sequence classification method was used. Each fold was then ensembled to conduct validation on a new, unseen cohort of radiology notes.
